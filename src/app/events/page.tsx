...
export const metadata: Metadata = {
  title: "Events | Tees House Inc.",
  description: "Upcoming and past events from Tees House Inc. in Pensacola, FL."
}
        ...
        <section className="bg-green-dark text-white py-20 px-4">
          <div className="container-max text-center">
            ...
            <p className="text-green-light text-lg max-w-xl mx-auto">
              Connect with Tees House at our upcoming programs, fundraisers, and community gatherings.
            </p>
          </div>
        </section>
