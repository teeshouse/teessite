...
const roles = [
  ...
  { Icon: Palette,       title: "Creative Arts",                   desc: "Lead or assist in art workshops focused on self-expression, healing, and community engagement." },
  { Icon: CalendarDays,  title: "Event Support",                   desc: "Set up and run community events including farmers markets, art showcases, and fundraisers." },
  { Icon: BookOpen,      title: "Workshop Support & Education",    desc: "Share your expertise by teaching or assisting in workshops covering urban farming, wellness, or healthy living." },
  ...
  { Icon: Megaphone,     title: "Community Outreach & Ambassador", desc: "Connect with schools, businesses, and partner organizations. Help recruit volunteers and promote events." },
  { Icon: ClipboardList, title: "Administrative",                  desc: "Support day-to-day operations with data entry, file organization, volunteer scheduling, and event logistics." }
]
            ...
            <div className="card p-8 space-y-6">
              ...
              {status==="error"&&(
                <p className="text-red-500 text-sm text-center">
                  Something went wrong. Please email us at info@mail.teeshouse.org
                </p>
              )}
