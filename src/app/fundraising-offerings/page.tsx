...
import { PayPalHostedButton, PayPalSubscriptionButton } from "@/components/PayPalButton"
...
const FALLBACK_KITS: Service[] = [
  ...
  },
  {
    ...
    price: "Starting at $19.99", isSubscription: true,
              ...
              {kits.map((kit) => (
                <div key={kit._id}
                  className={`card overflow-hidden hover:-translate-y-1 transition-transform duration-300 flex flex-col
                    ${kit.isSubscription ? "border-2 border-amber" : ""}`}>
